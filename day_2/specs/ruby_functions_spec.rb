...
class Functions_Practice < MiniTest::Test
  ...
  def test_volume_of_sphere()
      ...
      assert_equal(113.10, volume)
  end

  # #You can add your own converters
  def test_fahrenheit_to_celsius()
      celsius = fahrenheit_to_celsius(60)
      assert_equal(15.56, celsius)
  end

  #additional practice
  def test_drummonds_chat
    drummond_says = drummonds_chat("I like pizza and beans")
    assert_equal("I like kizza and geans", drummond_says)
  end
